...
<%Start();%>
<div class="jsxxk">
<dl id="tabheads"  class="tabheadstyles">
<dd>按职称排列</dd>
<dd>按教研室排列</dd>

</dl>
<dl id="tabcontents"  class="tabcontentstyles">
<dd>
<% 

DataTable dt=Get_Data("select * from jsjj where pa_zc=sz"); 
DataRow dr;
...
<div>教授</div>
<div>
<a href="<%=Detail_Url(dr,"jsjj")%>"><%=dr["title"].ToString()%></a><br>
</div>
<%}else if(sz=='3'){%>
<div>副教授</div>
<div>
...
tabs("tabheads","tabcontents","onmouseover");

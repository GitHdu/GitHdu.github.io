...
<%if(IsSearch==0){conn.Open();%><ul class="tpxw">
<% 
string pic="";
...
<%if(pic!=""){%><li class="tw"><div class="qwe"><img src="<%=dr["titlepic"].ToString()%>"><div class="InfoTitle"><a href="<%=Detail_Url(dr)%>"><%=dr["title"].ToString()%></a></div><%=SubStr(dr["pa_introduct"].ToString(),200,true)%></div></li>
<%}
else
{%>
<li class="tw"><div class="qwe"><img src="<%=piclj%>"><div class="InfoTitle"><a href="<%=Detail_Url(dr)%>"><%=dr["title"].ToString()%></a></div><p><%=SubStr(dr["pa_introduct"].ToString(),200,true)%></p></div></li>
<%
}
%>
